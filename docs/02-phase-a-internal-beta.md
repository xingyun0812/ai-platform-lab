...
在 [第 6 周学习版](./01-week6-hardening.md) 之上，把 **状态外置、任务异步、审计落库、CI 门禁** 做到团队内测可用。路线图见 [roadmap.md](./00-roadmap.md)。
...
构建思路、使用链路与逐文件代码说明见 [phase-a-build-and-code-guide.md](./02-phase-a-guide.md)。
...
详见 [roadmap.md](./00-roadmap.md) Phase B。
