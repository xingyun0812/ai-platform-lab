...
构建思路、使用链路与逐文件代码说明见 [phase-g-build-and-code-guide.md](./02-phase-g-00-guide.md)。
...
**文档**：`docs/02-phase-g-02-embedding.md`  
...
4. **无多模态支持**：仅文本 embedding；图像/音频 embedding（如 CLIP）需额外 provider 实现。→ **Phase P P1 已补** text+image inputs + stub-multimodal，见 [phase-p-multimodal-embedding.md](./02-phase-p-multimodal-embedding.md)。
