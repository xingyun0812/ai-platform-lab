...
与 [AI中台学习执行手册](./90-ai-learning-handbook.md) 第 6 周配套。本仓库是 **教学用最小骨架**，不是生产级多区域部署。
...
- [roadmap.md](./00-roadmap.md) — 已知限制与后续路线
- [phase-e-agent-quality.md](./02-phase-e-agent-quality.md) — Phase E 交付说明
- [enterprise-ai-platform-sop.md](./02-phase-e-sop.md) — 大厂 SOP 与踩坑对照
- [week6-hardening.md](./01-week6-hardening.md) — 第 6 周验收与演示
- [hardening-build-and-code-guide.md](./01-week6-guide.md) — 代码导读
