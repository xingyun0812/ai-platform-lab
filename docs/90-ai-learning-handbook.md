...
- `docs/01-week1-gateway.md`：接口说明 + 错误码表 + 本地启动命令
...
- `docs/01-week2-rag-pipeline.md`：数据流说明 + 任务状态查询方式
...
- `docs/01-week4-agent-runtime.md`：工具注册说明 + 租户授权矩阵
...
- `docs/01-week5-observability-eval.md`：如何开 trace、如何跑 eval、如何看对比
...
- [x] `docs/00-architecture.md`：Mermaid 一张 **分层图** + 数据流
- [x] `docs/00-roadmap.md`：诚实写未做：计费精确到 token、多 region、权限审计细化等
...
→ [enterprise-ai-platform-sop.md](./02-phase-e-sop.md)（含 **§ Agent 效果进阶**：选工具准确性、长上下文，按 Phase E 规划对照）
