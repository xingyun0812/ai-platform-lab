...
> 规格书：[orchestrator](./02-phase-h-01-orchestrator.md) · [multi-agent](./02-phase-h-02-multi-agent.md) · [lifecycle](./02-phase-h-03-agent-lifecycle.md) · [hitl](./02-phase-h-04-hitl.md)
