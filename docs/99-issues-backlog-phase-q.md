...
> 规划：[phase-q-advanced-planning.md](./02-phase-q-00-advanced-planning.md)  
...
**目标**：评审 `docs/02-phase-q-00-advanced-planning.md`，创建 Q1～Q6 Issue，更新 `00-roadmap.md`。

**验收**：
- [x] `docs/02-phase-q-00-advanced-planning.md` 评审通过
- [x] Milestone Phase Q 内 Q1～Q6 Issue 创建完毕（#116～#121）
- [x] `00-roadmap.md` 增加 Phase Q 章节
...
- [x] `90-demo-walkthrough.md` 增 Phase Q 段
