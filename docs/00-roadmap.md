...
> 参见完整对比图：[gap-analysis-diagram.md](./90-gap-analysis-diagram.md)  
> 甘特图：[roadmap-gantt.md](./00-roadmap-gantt.md)
...
文档：[phase-f-prompt-registry.md](./02-phase-f-01-prompt-registry.md) · [phase-f-prompt-experiment.md](./02-phase-f-02-prompt-experiment.md) · [phase-f-memory.md](./02-phase-f-03-memory.md) · [phase-f-context-compress.md](./02-phase-f-05-context-compress.md) · [phase-f-mcp.md](./02-phase-f-04-mcp.md)
...
文档：[phase-g-semantic-cache.md](./02-phase-g-01-semantic-cache.md)
...
文档：[phase-h-orchestrator.md](./02-phase-h-01-orchestrator.md) · [phase-h-multi-agent.md](./02-phase-h-02-multi-agent.md) · [phase-h-agent-lifecycle.md](./02-phase-h-03-agent-lifecycle.md) · [phase-h-hitl.md](./02-phase-h-04-hitl.md)
...
文档：[phase-i-sandbox.md](./02-phase-i-01-sandbox.md) · [phase-i-audit-actions.md](./02-phase-i-02-audit-actions.md) · [phase-i-pii.md](./02-phase-i-03-pii.md) · [phase-i-auth.md](./02-phase-i-04-auth.md)
...
文档：[phase-j-python-sdk.md](./02-phase-j-01-python-sdk.md) · [phase-j-console-v2.md](./02-phase-j-02-console-v2.md) · [phase-j-eval-pipeline.md](./02-phase-j-03-eval-pipeline.md) · [phase-j-feedback-loop.md](./02-phase-j-04-feedback-loop.md)
...
文档：[phase-k-object-storage.md](./02-phase-k-object-storage.md) · [phase-k-helm.md](./02-phase-k-helm.md) · [phase-k-multi-az.md](./02-phase-k-multi-az.md) · [phase-k-gpu-scheduling.md](./02-phase-k-gpu-scheduling.md)
...
> **规划**：[phase-l-engineering-depth.md](./02-phase-l-00-engineering-depth.md) · Issue 正文：[issues-backlog-phase-l.md](./99-issues-backlog-phase-l.md)  
...
> ROI 说明：[phase-l-priority-roi.md](./02-phase-l-01-priority-roi.md) · Console 交付：[phase-l-console-integration.md](./02-phase-l-31-console-integration.md) · Demo：[demo-walkthrough.md](./90-demo-walkthrough.md)
...
> **规划**：[phase-m-incremental-index.md](./02-phase-m-incremental-index.md) · Issue 正文：[issues-backlog-phase-m.md](./99-issues-backlog-phase-m.md)  
...
> **规划**：[phase-n-pypi-sdk.md](./02-phase-n-pypi-sdk.md) · Issue 正文：[issues-backlog-phase-n.md](./99-issues-backlog-phase-n.md)  
...
> **规划**：[phase-o-agent-jd2-alignment.md](./02-phase-o-00-agent-jd2-alignment.md) · Issue 正文：[issues-backlog-phase-o.md](./99-issues-backlog-phase-o.md) · 规划 Issue [#86](https://github.com/xingyun0812/ai-platform-lab/issues/86)  
...
> **规划**：[phase-p-multimodal-embedding.md](./02-phase-p-multimodal-embedding.md) · [issues-backlog-phase-p.md](./99-issues-backlog-phase-p.md)  
...
> **规划**：[phase-q-advanced-planning.md](./02-phase-q-00-advanced-planning.md) · [issues-backlog-phase-q.md](./99-issues-backlog-phase-q.md)  
...
## Phase R — Agent Harness 前沿（✅ 全部完成）

> **动机**：对照 DeepSeek Harness 团队 JD，补齐 3 个核心缺口：自进化 Agent、跨 session 长程任务、Harness-side 模型能力探测  
> **规划**：[phase-r-agent-harness.md](./02-phase-r-00-agent-harness.md) · **Tag**：`phase-r-agent-harness` · **门禁**：`python eval/harness_capability_gate.py run`  
...
| [#136](https://github.com/xingyun0812/ai-platform-lab/issues/136) | Harness-side 模型能力探测 | ✅ PR #141 |
| [#137](https://github.com/xingyun0812/ai-platform-lab/issues/137) | eval 门禁 + tag | ✅ |

**Wave 2 完成！** R3 四维度 benchmark + 能力画像 + Router 反哺（#136）；R4 联合门禁 `harness_capability_gate.py` + baseline + tag `phase-r-agent-harness`。
...
> **状态**：✅ **已交付**（Phase S · 2026-08-05）
> **ADR**：[0004-tree-of-thoughts.md](./adr/0004-tree-of-thoughts.md)
> **门禁**：`python eval/tot_quality_gate.py run && gate`

| 组件 | 内容 | 状态 |
|------|------|------|
| S1 | BFS/DFS 树搜索框架（ThoughtNode/Tree/Config） | ✅ |
| S2 | 思维生成器 + 评估器（LLM） | ✅ |
| S3 | `POST /v1/agent/tot` 独立 API | ✅ |
| S4 | auto_plan + tot_config 注入 Planner | ✅ |
| S5 | ToT vs CoT eval 门禁 | ✅ |

**前置**：Phase Q（Graph Runtime） · Phase R（Harness） · CoT 推理模式

**后续**：
- Phase T: Multi-Agent Debate（规划中）
- Phase U: Deep Research（规划中）

---

## Phase T — Multi-Agent Debate（高级推理 ✅）

> **状态**：✅ **已交付**（Phase T · 2026-08-05）
> **ADR**：[0005-multi-agent-debate.md](./adr/0005-multi-agent-debate.md)
> **门禁**：`python eval/debate_quality_gate.py run && gate`

| 组件 | 内容 | 状态 |
|------|------|------|
| T1 | 辩论编排器（提案→评议→裁定） | ✅ |
| T2 | 辩论角色定义（proposer/critic/judge） | ✅ |
| T3 | `POST /v1/agent/debate` API | ✅ |
| T4 | 辩论 eval 门禁 | ✅ |

**前置**：Phase H（Multi-Agent）· Phase O（Delegation v2）· Phase S（ToT）

---

## Phase U — Deep Research（高级推理 ✅）

> **状态**：✅ **已交付**（Phase U · 2026-08-05）
> **ADR**：[0006-deep-research.md](./adr/0006-deep-research.md)
...
| U2 | 搜索+阅读+摘要循环 | ✅ |
| U3 | 信息综合 → 研究报告 | ✅ |
| U4 | `POST /v1/agent/research` API | ✅ |
| U5 | fetch_url 工具 | ✅ |

**前置**：Phase S（ToT）· Phase T（Debate）· web_search + fetch_url tools
...
- **Console V2 已挂载** → `/console/`（见 [phase-l-console-integration.md](./02-phase-l-31-console-integration.md)）。
...
| 文档 | 说明 |
|------|------|
| [gap-analysis-diagram.md](./90-gap-analysis-diagram.md) | 现状 vs 目标架构 Mermaid 对比图 |
| [roadmap-gantt.md](./00-roadmap-gantt.md) | Phase F~K 甘特图 |
| [architecture.md](./00-architecture.md) | 平台整体架构叙事 |
| [phase-e-agent-quality.md](./02-phase-e-agent-quality.md) | Phase E Agent 效果深化 |
| [phase-d-future-evolution.md](./02-phase-d-99-future-evolution.md) | Phase D 远期规划 |
| [enterprise-ai-platform-sop.md](./02-phase-e-sop.md) | 大厂 SOP 踩坑对照 |
| [phase-l-engineering-depth.md](./02-phase-l-00-engineering-depth.md) | Phase L 工程深度与面试叙事 ✅ |
| [interview-narrative.md](./90-interview-narrative.md) | 10 分钟面试口述稿 + Q&A |
| [phase-l-priority-roi.md](./02-phase-l-01-priority-roi.md) | Phase L ROI 优先级与 Issue 对照 |
| [phase-l-console-integration.md](./02-phase-l-31-console-integration.md) | Phase L Console 集成 ✅ |
| [demo-walkthrough.md](./90-demo-walkthrough.md) | 15 分钟平台 Demo 脚本 |
| [phase-s-tree-of-thoughts.md](./02-phase-s-tree-of-thoughts.md) | Phase S ToT 高级推理 ✅ |
| [phase-t-multi-agent-debate.md](./02-phase-t-multi-agent-debate.md) | Phase T Debate 高级推理 ✅ |
| [phase-u-deep-research.md](./02-phase-u-deep-research.md) | Phase U Deep Research ✅ |
| [phase-v-computer-use.md](./02-phase-v-computer-use.md) | Phase V Computer Use Agent ✅ |
| [issues-backlog-phase-l.md](./99-issues-backlog-phase-l.md) | Phase L Issue 正文 #53～#63 |
