...
> **读者**：已完成或跟做本仓库 [AI中台学习执行手册](./90-ai-learning-handbook.md) 的工程师，准备进入/面试 **平台 / 中台** 岗位。  
...
| 准备面试平台岗 | 全文 + [roadmap.md](./00-roadmap.md) 诚实边界 |
...
| 3 | 给 **接入文档 + 错误码表 + 沙箱环境** | `docs/01-week1-gateway.md` 等 |
...
| 无 roadmap | 面试被问「生产还差啥」答不出 | `docs/00-roadmap.md` |

**本仓库**：`week6-hardening`、`00-architecture.md`。
...
**本仓库文档**：[phase-b-small-production.md](./02-phase-b-small-production.md)、[phase-b2-parallel.md](./02-phase-b2-parallel.md)、[phase-b3-rerank-canary.md](./02-phase-b3-rerank-canary.md)
...
**本仓库**：[phase-c-platform.md](./02-phase-c-platform.md)
...
**本仓库**：[phase-d-ops.md](./02-phase-d-01-ops.md)
...
远期规划细节：[phase-d-future-evolution.md](./02-phase-d-99-future-evolution.md) §6.2 Agent 深化。
...
> 对应 [phase-d-future-evolution.md](./02-phase-d-99-future-evolution.md) D4 未做子集 + 下文扩展。Tag 建议：`phase-e-agent-quality`。
...
- [AI中台学习执行手册.md](./90-ai-learning-handbook.md) — 跟做任务清单  
- [roadmap.md](./00-roadmap.md) — 已知限制  
- [phase-d-future-evolution.md](./02-phase-d-99-future-evolution.md) — 后续演进  
- [architecture.md](./00-architecture.md) — 架构与数据流  
