...
> 配套学习手册：[AI中台学习执行手册](./90-ai-learning-handbook.md)  
> 当前代码范围：**第 1 周 LLM Gateway**（本文）；第 2 周 RAG 见 [rag-build-and-code-guide.md](./01-week2-guide.md)。
...
| `docs/01-week1-gateway.md` | ✅ 接口要点；细节见本文 |
...
- [week1-gateway.md](./01-week1-gateway.md) — 第 1 周验收要点
- [AI中台学习执行手册](./90-ai-learning-handbook.md) — 全 8 周路线  
- [rag-build-and-code-guide.md](./01-week2-guide.md) — 第 2 周 RAG 构建与代码导读
