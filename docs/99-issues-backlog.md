...
> **归档说明（2026-05-19）**：Phase J/K 已交付（见 [roadmap.md](./00-roadmap.md)）。下文各 Issue 正文内的 `- [ ]` 为**创建时模板**，不代表当前未完成。活跃 Phase 请用 `issues-backlog-phase-*.md`。
...
- [ ] README.md SDK 使用示例
- [ ] 设计文档 `docs/02-phase-j-01-python-sdk.md`
...
- `tests/test_sdk.py`
- `docs/02-phase-j-01-python-sdk.md`
...
- [ ] 设计文档 `docs/02-phase-j-02-console-v2.md`
...
- [ ] 设计文档 `docs/02-phase-j-03-eval-pipeline.md`
...
- `docs/02-phase-j-03-eval-pipeline.md`
...
- [ ] 单测 ≥ 12 个
- [ ] 设计文档 `docs/02-phase-j-04-feedback-loop.md`
...
- `docs/02-phase-j-04-feedback-loop.md`
...
- [ ] 设计文档 `docs/02-phase-k-object-storage.md`
...
- [ ] 文档 `docs/02-phase-k-helm.md`（部署 + 升级 + 回滚）
...
- [ ] 文档 `docs/02-phase-k-multi-az.md`
...
- [ ] 冷启动优化（模型预加载）
- [ ] 成本看板：GPU 小时费 + 节省率
- [ ] 文档 `docs/02-phase-k-gpu-scheduling.md`
...
4. **置顶 roadmap**：在仓库 About 链接 `docs/00-roadmap.md`
