...
> ✅ **Phase N 已完成**（tag `phase-n-pypi-sdk`）。验收以 [phase-n-pypi-sdk.md](./02-phase-n-pypi-sdk.md) 为准。

> 规划：[phase-n-pypi-sdk.md](./02-phase-n-pypi-sdk.md)  
...
- [x] Trusted Publishing 或 `PYPI_API_TOKEN` 文档写入 `.env.example` 注释 / `docs/02-phase-n-pypi-sdk.md`
...
**验收**（✅ 已完成）：
- [x] `docs/00-PROJECT_STATUS.md` 开发者体验 PyPI ✅
- [x] `docs/00-roadmap.md` 已知限制更新
- [x] `docs/90-interview-narrative.md` SDK 段 `pip install`
