...
学习计划见 [AI中台学习执行手册](./90-ai-learning-handbook.md) 第 6 周。  
构建思路、使用链路与逐文件代码说明见 [hardening-build-and-code-guide.md](./01-week6-guide.md)。
...
- **平台文档**：`00-architecture.md` + `00-roadmap.md`
...
| 文档 | 用途 |
|------|------|
| [architecture.md](./00-architecture.md) | 分层图 + 三条核心数据流 |
| [roadmap.md](./00-roadmap.md) | 已知限制与演进阶段 |
...
- [ ] 能打开 `00-architecture.md` 对照口述租户 / RAG / Agent / eval
