...
> 规格书：[prompt-registry](./02-phase-f-01-prompt-registry.md) · [A/B](./02-phase-f-02-prompt-experiment.md) · [memory](./02-phase-f-03-memory.md) · [MCP](./02-phase-f-04-mcp.md) · [compress](./02-phase-f-05-context-compress.md)
