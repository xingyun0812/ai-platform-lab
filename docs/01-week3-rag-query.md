...
学习计划见 [AI中台学习执行手册](./90-ai-learning-handbook.md) 第 3 周。  
构建思路与代码导读见 [rag-query-build-and-code-guide.md](./01-week3-guide.md)。  
第 2 周索引与对内检索见 [week2-rag-pipeline.md](./01-week2-rag-pipeline.md)。
...
2. 已对 `lab-demo` 索引至少一个版本（见 [week2-rag-pipeline.md](./01-week2-rag-pipeline.md)）。
