...
> **Integration note for shared-file maintainer**: No changes to `apps/gateway/main.py`, `apps/gateway/settings.py`, `.env.example`, or `docs/00-roadmap.md` are needed for this issue.
