...
> 配套学习手册：[AI中台学习执行手册](./90-ai-learning-handbook.md) 第 2 周。  
> API 与可复制演示命令见 [week2-rag-pipeline.md](./01-week2-rag-pipeline.md)。  
> 第 1 周 Gateway 见 [gateway-build-and-code-guide.md](./01-week1-guide.md)。
...
| 交付 `docs/01-week2-rag-pipeline.md` | ✅；本文档为**构建 + 代码导读**补充 |
...
完整 curl 见 [week2-rag-pipeline.md](./01-week2-rag-pipeline.md#演示命令可复制)。
...
| 第 2 周 | 第 3 周（见 [rag-query-build-and-code-guide.md](./01-week3-guide.md)） |
|--------|--------|
...
- [week2-rag-pipeline.md](./01-week2-rag-pipeline.md) — API、演示命令、验收表  
- [gateway-build-and-code-guide.md](./01-week1-guide.md) — 第 1 周 Gateway  
- [AI中台学习执行手册.md](./90-ai-learning-handbook.md) — 全路线  
