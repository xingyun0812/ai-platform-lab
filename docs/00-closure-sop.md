...
5. `phase-*.md` §验证矩阵  
6. `90-demo-walkthrough.md` Live 表（live 手验后改 ✅）  
7. `00-roadmap.md` 状态 ✅ + tag  
8. 可选：`90-interview-narrative.md` 一句话  
...
| 文件 | 规则 |
|------|------|
| `99-issues-backlog.md` | **历史模板**；内嵌 `[ ]` 不代表未完成 |
| `issues-backlog-phase-*.md` | 以顶部 **状态表** 为准；Phase 完成后在文首标 ✅ |
| `00-PROJECT_STATUS.md` | **每个 tag 后**更新一次 |
