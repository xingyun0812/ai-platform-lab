...
详见 [phase-q-advanced-planning.md §Q7](./02-phase-q-00-advanced-planning.md#q7--graph-runtime最小-langgraph-等价物)。
...
- 1 份样例报告 `docs/02-phase-r-04-capability-report-sample.md`
...
- 文档：`90-demo-walkthrough.md` 增 Phase R 段
