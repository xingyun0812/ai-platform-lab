...
构建思路、使用链路与逐文件代码说明见 [phase-k-build-and-code-guide.md](./02-phase-k-00-guide.md)。
---
...
16. `docs/02-phase-k-multi-az.md` exists with required sections
...
| `docs/02-phase-k-multi-az.md` | This design doc |
...
See [docs/02-phase-k-multi-az.md](docs/02-phase-k-multi-az.md) for full topology details.
```

**Roadmap update** (docs/00-roadmap.md): Mark #51 (多 AZ 高可用) as ✅ Completed.
