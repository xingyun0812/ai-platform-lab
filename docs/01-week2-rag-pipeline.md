...
学习计划见 [AI中台学习执行手册](./90-ai-learning-handbook.md) 第 2 周。  
构建思路、使用链路与逐文件代码说明见 [rag-build-and-code-guide.md](./01-week2-guide.md)。  
第 1 周 Gateway 见 [gateway-build-and-code-guide.md](./01-week1-guide.md)。  
第 3 周对外问答见 [week3-rag-query.md](./01-week3-rag-query.md)。
