...
> 规格书：[sandbox](./02-phase-i-01-sandbox.md) · [audit-actions](./02-phase-i-02-audit-actions.md) · [pii](./02-phase-i-03-pii.md) · [auth](./02-phase-i-04-auth.md)

---

## 目录

构建思路、使用链路与逐文件代码说明见 [phase-i-build-and-code-guide.md](./02-phase-i-00-guide.md)。
