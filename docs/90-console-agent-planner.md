...
- [phase-o-web-search.md](./02-phase-o-04-web-search.md) — web_search 工具配置
- [demo-walkthrough.md](./90-demo-walkthrough.md) — 15 分钟 Demo
- [phase-l-console-integration.md](./02-phase-l-31-console-integration.md) — Console 挂载
