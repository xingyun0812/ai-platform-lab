...
> 规格书：[python-sdk](./02-phase-j-01-python-sdk.md) · [console-v2](./02-phase-j-02-console-v2.md) · [eval-pipeline](./02-phase-j-03-eval-pipeline.md) · [feedback-loop](./02-phase-j-04-feedback-loop.md)

---

## 目录

构建思路、使用链路与逐文件代码说明见 [phase-j-build-and-code-guide.md](./02-phase-j-00-guide.md)。
