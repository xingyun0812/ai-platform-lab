...
> **配套**：[demo-walkthrough.md](./90-demo-walkthrough.md)（动手演示）、[roadmap.md](./00-roadmap.md) §已知限制（诚实边界）。
...
引用 [roadmap.md](./00-roadmap.md) §已知限制，核心三点：
...
详见 [demo-walkthrough.md](./90-demo-walkthrough.md)。
...
> 环境细节：[local-llm-setup.md](./01-local-llm-setup.md)
...
详见 [demo-walkthrough.md](./90-demo-walkthrough.md) §Agent JD2。

## 相关文档

| 文档 | 用途 |
|------|------|
| [local-llm-setup.md](./01-local-llm-setup.md) | 内网 LLM 网关 + 三模型 + `.env` |
| [enterprise-ai-platform-sop.md](./02-phase-e-sop.md) | 大厂 SOP 对照 |
| [architecture.md](./00-architecture.md) | 架构全景 |
| [phase-l-priority-roi.md](./02-phase-l-01-priority-roi.md) | 下一步 ROI |
| [PROJECT_STATUS.md](./00-PROJECT_STATUS.md) | 一页纸状态 |
