...
> B1：[phase-b-small-production.md](./02-phase-b-small-production.md) · B2：[phase-b2-parallel.md](./02-phase-b2-parallel.md) · B3：[phase-b3-rerank-canary.md](./02-phase-b3-rerank-canary.md) · 前置：[Phase A](./02-phase-a-guide.md)
