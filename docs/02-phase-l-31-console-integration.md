...
> **对照**：[phase-l-priority-roi.md](./02-phase-l-01-priority-roi.md) · 剩余 Demo/SDK 见 #62、#63
...
- [ ] `docs/90-demo-walkthrough.md` 全链路 live 录制清单
- [ ] `eval/platform_demo.sh` 全绿
- [ ] `eval/sdk_smoke.py` chat/rag/agent 三接口
- [ ] `docs/90-interview-narrative.md` 10 分钟背诵稿
...
- [demo-walkthrough.md](./90-demo-walkthrough.md)
- [phase-j-console-v2.md](./02-phase-j-02-console-v2.md) — Phase J 原始设计
- [console-tenant-billing.md](./90-console-tenant-billing.md) — 租户本月用量与 Billing 对接
- [issues-backlog-phase-l.md](./99-issues-backlog-phase-l.md) — #62-console / #62 / #63
