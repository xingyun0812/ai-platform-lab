...
- [x] `docs/00-roadmap.md` / `00-PROJECT_STATUS.md` / 叙事同步
...
| 文档 | 用途 |
|------|------|
| [phase-g-embedding.md](./02-phase-g-02-embedding.md) | Embedding 服务基线 |
| [issues-backlog-phase-p.md](./99-issues-backlog-phase-p.md) | Issue 正文 |
